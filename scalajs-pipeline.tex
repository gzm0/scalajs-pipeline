...
% Frame number on page & translation box
\setbeamertemplate{footline}{
  \parbox{\paperwidth}{
    \makebox[0.98\paperwidth][r]{\raisebox{1.2ex}{\large \insertframenumber}}\\
    \colorbox{black}{
      \parbox{\paperwidth}{
        \Large\color{black}Line 1\\Line 2
      }
    }
  }
}
...
\begin{frame}
  ...
  \begin{center}
    \begin{tikzpicture}[->,thick]
      \useasboundingbox (0,0) rectangle (10,5.75);
      ...
      % Linkage Error
      \node<6>[text width=3cm] at (8.5,0.5) {At run time: \texttt{NoClassDefFoundError}};
...
\begin{frame}[label=scalajspipeline]
  ...
  \begin{center}
    \begin{tikzpicture}[->,thick]
      ...
      \node<-4>[label=below:app.sjsir] (sjsir1) at (5.5,4.5) {\sjsirFiles};
      \node<3-4>[label=app.class] (class1) at (5.5,5.9) {\classFiles};
      \node<5->[label=below:app.jar] (jar1) at (5.5,4.5) {\sjsirclassFiles};
      \node<5-> at (5,5.2) {\packageIcon};
      ...
      \node<-4>[label=below:lib.sjsir] (sjsir2) at (5.5,0) {\sjsirFiles};
      \node<3-4>[label=lib.class] (class2) at (5.5,1.4) {\classFiles};
      \node<5->[label=below:lib.jar] (jar2) at (5.5,0) {\sjsirclassFiles};
      \node<5-> (p2) at (5,.6) {\packageIcon};
      ...
      % Linkage Error
      \node<7>[text width=3cm] at (9.3,0.5) {At link time: \texttt{MissingClass}};
...
\sK{class} MultiAlerter \{
  ...
  \uncover<1,3>{\sK{def} $js$exported$meth$multiAlert(n: Int): Any =
    multiAlert(n)}
\}
