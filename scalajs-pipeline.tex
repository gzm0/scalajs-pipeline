...
\begin{frame}
  ...
  \begin{center}
    \begin{tikzpicture}[->,thick]
      ...
      % Bottom pipeline
      \node<3-4,7>[label=below:lib.scala] (scala2) at (0,.5) {\scalaFiles};
      \node<3-4,7> (scalac2) at (2.5,.5) {\scalac};
      \node<3->[label=below:lib.jar] (class2) at (5.5,.5) {\classFiles};
      \node<3-> (jar2) at (5, 1.2) {\packageIcon};

      \draw<3-4,7> (scala2) -- (scalac2);
      \draw<3-4,7> (scalac2) -- (class2);
      ...
      % Compilation symbols
      \draw<4,7> (jar2) -- (scalac1);

      % Wrong Jar
      \node<5-6>[label=below:lib2.jar] (class3) at (2.5,.5) {\classFiles};
      \node<5-6> at (2, 1.2) {\packageIcon};
      \draw<5-6> (class3) -- (scalac1);
...
\begin{frame}[label=scalajspipeline]
  ...
  \begin{center}
    \begin{tikzpicture}[->,thick]
      ...
      % Bottom pipeline
      \node<1-4,7>[label=below:lib.scala] (scala2) at (0,.5) {\scalaFiles};
      \node<1-4,7> (scalajsc2) at (2.5,.5) {\scalajsc};
      ...
      \draw<1-4,7> (scala2) -- (scalajsc2);
      \draw<-3> (scalajsc2) -- (sjsir2);
      \draw<2-3> (scalajsc2) -- (class2);
      \draw<4,7> (scalajsc2) -- (jar2);
      ...
      \draw<4,7> (p2) -- (scalajsc1);

      % Wrong Jar
      \node<5-6>[label=below:lib2.jar] (jar3) at (2.5,.5) {\sjsirclassFiles};
      \node<5-6> at (2, 1.2) {\packageIcon};
      \draw<5-6> (class3) -- (scalac1);

      % Linkage Error
      \node<6>[text width=3cm] at (10.5,4.5) {At link time: \texttt{MissingClass}};
